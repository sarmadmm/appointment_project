...
import 'package:flutter_localization_master/widgets/const.dart';
import 'package:flutter_localization_master/widgets/full_photo.dart';
import 'package:flutter_localization_master/widgets/loading.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Widget buildItem(int index, DocumentSnapshot document) {
    if (document != null) {
      // first current user side i.e right side
